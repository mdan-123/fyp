...
LOGICAL_INTENT_PAIRS = {
    ...
    "UPDATE_TASK": ["SET_REMINDER", "CREATE_TASK", "COMPLETE_TASK"],
    "DELETE_TASK": ["CREATE_TASK", "QUERY_TASK"],
    "CHANGE_RECURRENCE": ["UPDATE_EVENT", "SET_REMINDER", "DELETE_EVENT"],
    "SET_PREFERENCES": ["CREATE_EVENT", "FIND_FREE_TIME", "SET_REMINDER"],
}
...
STUDENT_TASKS = [
    ...
    "print out the notes", "print the lecture slides",
    "check the submission portal", "check if the marks are out",
    "apply for an extension", "check the timetable",
]
...
RECREATION_TASKS = [
    ...
    "call a friend", "call mum", "ring dad", "send a birthday card",
    "tidy the bedroom", "tidy up the house", "fill in the form",
    "apply for the permit", "text someone back", "catch up with a friend",
]
...
STATIC_TIMES = [
    ...
    "this weekend", "next weekend", "at the weekend",
    "this Tuesday", "this Wednesday", "this Thursday", "this Saturday", "this Sunday",
    "in 5 minutes", "in 10 minutes", "in 20 minutes",
    "this month", "in a couple of days",
    "on the 1st", "on the 5th", "on the 10th", "on the 15th", "on the 20th", "on the 25th",
]
...
PAST_COMPLETE_VERBS = [
    "finished", "completed", "wrapped up", "closed out", "finalised",
    "ticked off", "knocked out", "checked off", "sorted out", "done with",
]
...
def fill_template(template: str, pools: Dict, context: str) -> Optional[str]:
    ...
    if "{past_complete}" in filled:
        filled = filled.replace("{past_complete}", random.choice(PAST_COMPLETE_VERBS))
