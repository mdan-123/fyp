...
export default function SettingsPage() {
  ...
  const renderActiveComponent = () => {
    ...
    switch (activeSetting) {
      ...
      case "scheduling":
        return <SchedulingSettings key={`sched-${refreshKey}`} userId={user.uid} onBack={handleBack} />;
      case "snooze-ledger":
        return <SnoozeLedger key={`snooze-${refreshKey}`} userId={user.uid} onBack={handleBack} />;
      default:
        return (
